...
class Data {
  ...
  String profileType;
  Merchant merchant;
  Map<String, RecentTransaction> recentTransactions;

  factory Data.fromJson(Map<String, dynamic> json) {

    // var list = json['recentTransactions'] ;
    ...
    return Data(
      ...
      recentTransactions: Map.from(json["recentTransactions"]).map((k, v) => MapEntry<String, RecentTransaction>(k, RecentTransaction.fromJson(v))),
    );
  }
  ...
  Map<String, dynamic> toJson() => {
    ...
    "recentTransactions": Map.from(recentTransactions).map((k, v) => MapEntry<String, dynamic>(k, v.toJson())),
  };
}
